    ...
    <imp-panel>
      ...
      <el-row slot="body" :gutter="24" style="margin-bottom: 20px;">
        <el-col :span="8" style="margin-bottom: 20px;">
          <el-tree v-if="roleTree" :data="roleTree" ref="roleTree" :default-expand-all='false' :expand-on-click-node='false' :show-checkbox='false' highlight-current style="font-size:14px" @node-click="handleNodeClick" clearable node-key="id" :props="defaultProps"></el-tree>
        </el-col>
        <el-col :span="16">
          <el-card class="box-card">
            <div class="select-tree">
              <el-tree :check-strictly="true" :data="resourceTree" ref="resourceTree" :default-expand-all='false' show-checkbox style="font-size:14px" node-key="id" v-loading="dialogLoading" :props="defaultMenuProps">
              </el-tree>
            </div>
...
export default {
    ...
    methods: {
        ...
        configRoleResources() {
            ...
            const roleMenuSet = {
                GROUP_ID: this.$refs.roleTree.getCurrentKey(),
                MENU_ID: checkedKeys.join(",")
            };
            let type = "success";
