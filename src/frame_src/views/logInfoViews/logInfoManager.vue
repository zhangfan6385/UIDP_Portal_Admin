<template>
  <div class="app-container calendar-list-container">
    ...
    <el-card class="box-card">
      <el-table :key='tableKey' :header-cell-class-name="tableRowClassName" :data="list" v-loading="listLoading" element-loading-text="给我一点时间" border fit highlight-current-row style="width: 100%">
        ...
        <el-table-column width="280px" :show-overflow-tooltip="true" align="center" :label="'组织机构'">
          <template slot-scope="scope">
...
<script>
import { fetchLogInfoList } from "@/frame_src/api/logInfo";
