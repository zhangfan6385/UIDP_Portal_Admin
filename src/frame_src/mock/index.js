...
Mock.mock(/\/notice\/fetchNoticeList/, 'get', noticeAPI.fetchNoticeList)
//项目维护zp
import projectAPI from './project'
Mock.mock(/\/project\/fetchProjectList/, 'get', projectAPI.fetchProjectList)
//开发平台维护zp
import platformAPI from './platform'
Mock.mock(/\/platform\/fetchPlatformList/, 'get', platformAPI.fetchPlatformList)
Mock.mock(/\/goplatform\/fetchGoPlatformList/, 'get', platformAPI.fetchPlatformList)
//组件维护zp
// import componentsAPI from './components'
// Mock.mock(/\/components\/fetchPlatformList/, 'get', componentsAPI.fetchComponentsList)
// //服务维护zp
// import serviceAPI from './service'
// Mock.mock(/\/service\/fetchPlatformList/, 'get', serviceAPI.fetchServiceList)
//社区维护zp
import communityAPI from './community'
Mock.mock(/\/community\/fetchCommunityList/, 'get', communityAPI.fetchCommunityList)
export default Mock
